    ...
    <div className={styles.wordListContainer}>
      ...
      <div className={styles.importantLettersContainer}>
        <div className={styles.importantLettersRow}>
          {highlightedLetters.map((letterObj) => {
            ...
            return (
              <span
                ...
                className={classnames(styles.displayLetter, {
          ...
          {highlightedLetters.filter((letterObj) => letterObj.highlighted)
            .length > 0 ? (
            <img
              alt="Clear"
              onClick={handleClearImpLetters}
              src="/x-circle-thick.svg"
            />
          ) : null}
        </div>
      </div>
        ...
        return (
          <div key={`${size}-size-words`} className={styles.letterSection}>
            <div className={styles.letterSectionHeader}>
              <h3>{size} letters</h3> ({words[size].length} word
              {words[size].length > 1 ? "s" : ""})
            </div>
